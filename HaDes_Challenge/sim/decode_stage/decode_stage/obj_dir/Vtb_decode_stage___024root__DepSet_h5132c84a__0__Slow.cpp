...
VL_ATTR_COLD void Vtb_decode_stage___024root___eval_initial__TOP(Vtb_decode_stage___024root* vlSelf) {
    ...
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_decode_stage___024root___eval_initial__TOP\n"); );
    // Init
    VlWide<5>/*159:0*/ __Vtemp_hd46f20cc__0;
    // Body
    __Vtemp_hd46f20cc__0[0U] = 0x2e766364U;
    __Vtemp_hd46f20cc__0[1U] = 0x74616765U;
    __Vtemp_hd46f20cc__0[2U] = 0x64655f73U;
    __Vtemp_hd46f20cc__0[3U] = 0x6465636fU;
    __Vtemp_hd46f20cc__0[4U] = 0x74625fU;
    vlSymsp->_vm_contextp__->dumpfile(VL_CVT_PACK_STR_NW(5, __Vtemp_hd46f20cc__0));
...
VL_ATTR_COLD void Vtb_decode_stage___024root___eval_triggers__stl(Vtb_decode_stage___024root* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_decode_stage__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vtb_decode_stage___024root___eval_triggers__stl\n"); );
    // Body
