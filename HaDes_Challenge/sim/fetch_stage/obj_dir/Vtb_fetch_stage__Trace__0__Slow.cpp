...
VL_ATTR_COLD void Vtb_fetch_stage___024root__trace_init_sub__TOP__0(Vtb_fetch_stage___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+32,"NOP_INSTR", false,-1, 31,0);
    tracep->declBit(c+27,"clk", false,-1);
    tracep->declBit(c+1,"rst", false,-1);
    tracep->declBus(c+7,"instruction_reg_out", false,-1, 31,0);
    tracep->declBus(c+8,"program_counter_reg_out", false,-1, 31,0);
    tracep->declBus(c+9,"status_forwards_out", false,-1, 3,0);
    tracep->declBus(c+2,"status_backwards_in", false,-1, 1,0);
    tracep->declBus(c+3,"jump_address_backwards_in", false,-1, 31,0);
    tracep->declBit(c+4,"force_error", false,-1);
    ...
    tracep->declBus(c+3,"jump_address_backwards_in", false,-1, 31,0);
    tracep->declBus(c+32,"NOP_INSTR", false,-1, 31,0);
    tracep->declBus(c+10,"wb_state", false,-1, 0,0);
    tracep->declBus(c+11,"pc", false,-1, 31,0);
    tracep->declBus(c+12,"request_pc", false,-1, 31,0);
    tracep->declBit(c+13,"pending_valid", false,-1);
    tracep->declBus(c+14,"pending_instr", false,-1, 31,0);
    tracep->declBus(c+15,"pending_pc", false,-1, 31,0);
    tracep->declBus(c+16,"pending_status", false,-1, 3,0);
    tracep->declBit(c+17,"kill_response", false,-1);
    tracep->declBit(c+5,"downstream_stall", false,-1);
    tracep->declBit(c+6,"downstream_jump", false,-1);
    tracep->declBit(c+28,"response_valid", false,-1);
    tracep->declBit(c+24,"response_is_error", false,-1);
    tracep->declBit(c+29,"can_request", false,-1);
...
VL_ATTR_COLD void Vtb_fetch_stage___024root__trace_init_sub__TOP__tb_fetch_stage__DOT__wb__0(Vtb_fetch_stage___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBus(c+18,"adr", false,-1, 31,0);
    tracep->declBus(c+19,"sel", false,-1, 3,0);
    tracep->declBus(c+20,"dat_mosi", false,-1, 31,0);
    tracep->declBus(c+25,"dat_miso", false,-1, 31,0);
    tracep->declBit(c+21,"cyc", false,-1);
    tracep->declBit(c+22,"stb", false,-1);
    tracep->declBit(c+23,"we", false,-1);
    tracep->declBit(c+26,"ack", false,-1);
    tracep->declBit(c+24,"err", false,-1);
}
...
VL_ATTR_COLD void Vtb_fetch_stage___024root__trace_full_sub_0(Vtb_fetch_stage___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,(vlSelf->tb_fetch_stage__DOT__force_error));
    bufp->fullBit(oldp+5,((1U == (IData)(vlSelf->tb_fetch_stage__DOT__status_backwards_in))));
    bufp->fullBit(oldp+6,((2U == (IData)(vlSelf->tb_fetch_stage__DOT__status_backwards_in))));
    bufp->fullIData(oldp+7,(vlSelf->tb_fetch_stage__DOT__instruction_reg_out),32);
    bufp->fullIData(oldp+8,(vlSelf->tb_fetch_stage__DOT__program_counter_reg_out),32);
    bufp->fullCData(oldp+9,(vlSelf->tb_fetch_stage__DOT__status_forwards_out),4);
    bufp->fullBit(oldp+10,(vlSelf->tb_fetch_stage__DOT__dut__DOT__wb_state));
    bufp->fullIData(oldp+11,(vlSelf->tb_fetch_stage__DOT__dut__DOT__pc),32);
    bufp->fullIData(oldp+12,(vlSelf->tb_fetch_stage__DOT__dut__DOT__request_pc),32);
    bufp->fullBit(oldp+13,(vlSelf->tb_fetch_stage__DOT__dut__DOT__pending_valid));
    bufp->fullIData(oldp+14,(vlSelf->tb_fetch_stage__DOT__dut__DOT__pending_instr),32);
    bufp->fullIData(oldp+15,(vlSelf->tb_fetch_stage__DOT__dut__DOT__pending_pc),32);
    bufp->fullCData(oldp+16,(vlSelf->tb_fetch_stage__DOT__dut__DOT__pending_status),4);
    bufp->fullBit(oldp+17,(vlSelf->tb_fetch_stage__DOT__dut__DOT__kill_response));
    bufp->fullIData(oldp+18,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.adr),32);
    bufp->fullCData(oldp+19,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.sel),4);
    bufp->fullIData(oldp+20,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.dat_mosi),32);
    bufp->fullBit(oldp+21,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.cyc));
    bufp->fullBit(oldp+22,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.stb));
    bufp->fullBit(oldp+23,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.we));
    bufp->fullBit(oldp+24,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.err));
    bufp->fullIData(oldp+25,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.dat_miso),32);
    bufp->fullBit(oldp+26,(vlSymsp->TOP__tb_fetch_stage__DOT__wb.ack));
    bufp->fullBit(oldp+27,(vlSelf->tb_fetch_stage__DOT__clk));
    bufp->fullBit(oldp+28,(vlSelf->tb_fetch_stage__DOT__dut__DOT__response_valid));
    bufp->fullBit(oldp+29,((1U & (~ ((IData)(vlSelf->tb_fetch_stage__DOT__dut__DOT__wb_state) 
    ...
    bufp->fullIData(oldp+30,(vlSelf->tb_fetch_stage__DOT__init_mem__DOT__i),32);
    bufp->fullIData(oldp+31,(0x20U),32);
    bufp->fullIData(oldp+32,(0x13U),32);
