...
class Vtb_fetch_stage___024root final : public VerilatedModule {
  public:
    ...
    CData/*0:0*/ tb_fetch_stage__DOT__force_error;
    ...
    CData/*0:0*/ tb_fetch_stage__DOT__dut__DOT__can_request;
    ...
    IData/*31:0*/ tb_fetch_stage__DOT__init_mem__DOT__i;
    ...
    VlUnpacked<IData/*31:0*/, 256> tb_fetch_stage__DOT__mem;
