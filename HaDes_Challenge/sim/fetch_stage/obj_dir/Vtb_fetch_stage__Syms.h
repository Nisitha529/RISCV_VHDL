...
#ifndef VERILATED_VTB_FETCH_STAGE__SYMS_H_
#define VERILATED_VTB_FETCH_STAGE__SYMS_H_  // guard
...
class Vtb_fetch_stage__Syms final : public VerilatedSyms {
  public:
    // INTERNAL STATE
    Vtb_fetch_stage* const __Vm_modelp;
