...
#endif
                VL_FATAL_MT("tb_fetch_stage.sv", 6, "", "Settle region did not converge.");
            }
...
VL_ATTR_COLD void Vtb_fetch_stage___024root___eval_stl(Vtb_fetch_stage___024root* vlSelf) {
    ...
    // Body
    if (vlSelf->__VstlTriggered.at(0U)) {
        Vtb_fetch_stage___024root___stl_sequent__TOP__0(vlSelf);
    }
}
...
VL_ATTR_COLD void Vtb_fetch_stage___024root___dump_triggers__act(Vtb_fetch_stage___024root* vlSelf) {
    ...
    if (vlSelf->__VactTriggered.at(0U)) {
        VL_DBG_MSGF("         'act' region trigger index 0 is active: @(negedge tb_fetch_stage.clk)\n");
    }
    if (vlSelf->__VactTriggered.at(1U)) {
        VL_DBG_MSGF("         'act' region trigger index 1 is active: @(posedge tb_fetch_stage.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_fetch_stage___024root___dump_triggers__nba(Vtb_fetch_stage___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        VL_DBG_MSGF("         'nba' region trigger index 0 is active: @(negedge tb_fetch_stage.clk)\n");
    }
    if (vlSelf->__VnbaTriggered.at(1U)) {
        VL_DBG_MSGF("         'nba' region trigger index 1 is active: @(posedge tb_fetch_stage.clk)\n");
    }
...
VL_ATTR_COLD void Vtb_fetch_stage___024root___ctor_var_reset(Vtb_fetch_stage___024root* vlSelf) {
    ...
    for (int __Vi0 = 0; __Vi0 < 256; ++__Vi0) {
        vlSelf->tb_fetch_stage__DOT__mem[__Vi0] = VL_RAND_RESET_I(32);
    }
    vlSelf->tb_fetch_stage__DOT__force_error = VL_RAND_RESET_I(1);
    vlSelf->tb_fetch_stage__DOT__init_mem__DOT__i = VL_RAND_RESET_I(32);
    ...
    vlSelf->tb_fetch_stage__DOT__dut__DOT__can_request = VL_RAND_RESET_I(1);
