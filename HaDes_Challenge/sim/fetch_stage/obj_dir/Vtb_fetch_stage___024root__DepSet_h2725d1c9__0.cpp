...
void Vtb_fetch_stage___024root___nba_sequent__TOP__1(Vtb_fetch_stage___024root* vlSelf);
void Vtb_fetch_stage___024root___nba_comb__TOP__0(Vtb_fetch_stage___024root* vlSelf);
...
void Vtb_fetch_stage___024root___eval_nba(Vtb_fetch_stage___024root* vlSelf) {
    ...
    if (vlSelf->__VnbaTriggered.at(0U)) {
        Vtb_fetch_stage___024root___nba_sequent__TOP__1(vlSelf);
        vlSelf->__Vm_traceActivity[4U] = 1U;
    }
    if ((vlSelf->__VnbaTriggered.at(0U) | vlSelf->__VnbaTriggered.at(1U))) {
        Vtb_fetch_stage___024root___nba_comb__TOP__0(vlSelf);
    }
}
...
#endif
                    VL_FATAL_MT("tb_fetch_stage.sv", 6, "", "Active region did not converge.");
                }
...
#endif
                VL_FATAL_MT("tb_fetch_stage.sv", 6, "", "NBA region did not converge.");
            }
