...
VL_ATTR_COLD void Vtb_mcu_wishbone_interface___ctor_var_reset(Vtb_mcu_wishbone_interface* vlSelf) {
    if (false && vlSelf) {}  // Prevent unused
    Vtb_mcu__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
    VL_DEBUG_IF(VL_DBG_MSGF("+              Vtb_mcu_wishbone_interface___ctor_var_reset\n"); );
    // Body
