...
VL_INLINE_OPT VlCoroutine Vtb_writeback_stage___024root___eval_initial__TOP__2(Vtb_writeback_stage___024root* vlSelf) {
    ...
    // Init
    IData/*31:0*/ tb_writeback_stage__DOT____Vrepeat1;
    tb_writeback_stage__DOT____Vrepeat1 = 0;
    // Body
    tb_writeback_stage__DOT____Vrepeat1 = 0x2710U;
    while (VL_LTS_III(32, 0U, tb_writeback_stage__DOT____Vrepeat1)) {
        co_await vlSelf->__VtrigSched_ha16a72ed__0.trigger(
                                                           "@(posedge tb_writeback_stage.clk)", 
                                                           "tb_writeback_stage.sv", 
                                                           585);
        tb_writeback_stage__DOT____Vrepeat1 = (tb_writeback_stage__DOT____Vrepeat1 
                                               - (IData)(1U));
    }
    VL_WRITEF("[FAIL] Simulation timeout\n[%0t] %%Error: tb_writeback_stage.sv:587: Assertion failed in %Ntb_writeback_stage\n",
              64,VL_TIME_UNITED_Q(1000),-9,vlSymsp->name());
    VL_STOP_MT("tb_writeback_stage.sv", 587, "");
}
...
void Vtb_writeback_stage___024root___eval_triggers__act(Vtb_writeback_stage___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.at(0U) = ((IData)(vlSelf->tb_writeback_stage__DOT__clk) 
    ...
    vlSelf->__VactTriggered.at(2U) = ((~ (IData)(vlSelf->tb_writeback_stage__DOT__clk)) 
                                      & (IData)(vlSelf->__Vtrigrprev__TOP__tb_writeback_stage__DOT__clk));
