...
VL_ATTR_COLD void Vtb_top_cpu___024root___ctor_var_reset(Vtb_top_cpu___024root* vlSelf) {
    ...
    vlSelf->tb_top_cpu__DOT__expected_auipc_value = VL_RAND_RESET_I(32);
    vlSelf->tb_top_cpu__DOT__expected_jalr_link_value = VL_RAND_RESET_I(32);
    vlSelf->tb_top_cpu__DOT__fetch_pc_byte = VL_RAND_RESET_I(32);
    vlSelf->tb_top_cpu__DOT__fetch_word_index = VL_RAND_RESET_I(32);
    ...
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__producer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__producer_valid = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__consumer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__consumer_uses_rs1 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1387__consumer_uses_rs2 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1388__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1388__instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1389__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1389__op_i = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1390__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1390__op_i = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__producer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__producer_valid = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__consumer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__consumer_uses_rs1 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1391__consumer_uses_rs2 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1392__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1392__instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1393__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1393__op_i = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1394__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1394__op_i = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__producer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__producer_valid = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__consumer_instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__consumer_uses_rs1 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__source_match_late_producer__1395__consumer_uses_rs2 = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1396__Vfuncout = VL_RAND_RESET_I(1);
    VL_RAND_RESET_W(65, vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_late_rd_producer__1396__instr);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1397__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_load_op__1397__op_i = VL_RAND_RESET_I(6);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1398__Vfuncout = VL_RAND_RESET_I(1);
    vlSelf->__Vfunc_tb_top_cpu__DOT__dut__DOT__is_csr_op__1398__op_i = VL_RAND_RESET_I(6);
