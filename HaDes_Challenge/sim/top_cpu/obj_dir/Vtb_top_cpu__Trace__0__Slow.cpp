...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_init_sub__TOP__0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBit(c+151,"clk", false,-1);
    tracep->declBit(c+152,"rst", false,-1);
    tracep->declBit(c+157,"external_interrupt_in", false,-1);
    tracep->declBit(c+157,"timer_interrupt_in", false,-1);
    ...
    tracep->declBus(c+158,"writeback_backwards_out", false,-1, 1,0);
    ...
    tracep->declBus(c+159,"writeback_jump_addr", false,-1, 31,0);
    ...
    tracep->declBus(c+160,"status_forwards_in", false,-1, 3,0);
    ...
    tracep->declBus(c+107,"status_forwards_out", false,-1, 3,0);
    tracep->declBus(c+25,"status_backwards_in", false,-1, 1,0);
    tracep->declBus(c+28,"jump_address_backwards_in", false,-1, 31,0);
    tracep->declBus(c+163,"NOP_INSTR", false,-1, 31,0);
    tracep->declBus(c+108,"wb_state", false,-1, 0,0);
    tracep->declBus(c+109,"pc", false,-1, 31,0);
    tracep->declBus(c+110,"request_pc", false,-1, 31,0);
    tracep->declBit(c+111,"pending_valid", false,-1);
    tracep->declBus(c+112,"pending_instr", false,-1, 31,0);
    tracep->declBus(c+113,"pending_pc", false,-1, 31,0);
    tracep->declBus(c+114,"pending_status", false,-1, 3,0);
    tracep->declBit(c+115,"kill_response", false,-1);
    tracep->declBit(c+116,"downstream_stall", false,-1);
    tracep->declBit(c+117,"downstream_jump", false,-1);
    tracep->declBit(c+153,"response_valid", false,-1);
    tracep->declBit(c+145,"response_is_error", false,-1);
    tracep->declBit(c+118,"can_request", false,-1);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+160,"status_forwards_in", false,-1, 3,0);
    tracep->declBus(c+119,"status_forwards_out", false,-1, 3,0);
    tracep->declBus(c+158,"status_backwards_in", false,-1, 1,0);
    tracep->declBus(c+27,"status_backwards_out", false,-1, 1,0);
    tracep->declBus(c+159,"jump_address_backwards_in", false,-1, 31,0);
    tracep->declBus(c+30,"jump_address_backwards_out", false,-1, 31,0);
    tracep->declBit(c+120,"is_load", false,-1);
    tracep->declBit(c+121,"is_store", false,-1);
    tracep->declBus(c+122,"wb_state", false,-1, 0,0);
    tracep->declArray(c+123,"active_instr", false,-1, 64,0);
    tracep->declBus(c+126,"active_source_data", false,-1, 31,0);
    tracep->declBus(c+127,"active_rd_data", false,-1, 31,0);
    tracep->declBus(c+128,"active_pc", false,-1, 31,0);
    tracep->declBus(c+129,"active_next_pc", false,-1, 31,0);
    tracep->declBit(c+130,"active_is_load", false,-1);
    tracep->declBit(c+131,"active_is_store", false,-1);
    tracep->declBus(c+154,"load_value", false,-1, 31,0);
    tracep->popNamePrefix(1);
    ...
    tracep->declBus(c+160,"status_forwards_in", false,-1, 3,0);
    tracep->declBus(c+158,"status_backwards_out", false,-1, 1,0);
    tracep->declBus(c+159,"jump_address_backwards_out", false,-1, 31,0);
    tracep->declBit(c+132,"writes_rd", false,-1);
    tracep->popNamePrefix(2);
...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_init_sub__TOP__instruction__0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declArray(c+164,"NOP", false,-1, 64,0);
}
...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_init_sub__TOP__constants__0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBus(c+167,"MEMORY_START", false,-1, 31,0);
    tracep->declBus(c+168,"MEMORY_SIZE", false,-1, 31,0);
    tracep->declBus(c+169,"LEDS_START", false,-1, 31,0);
    tracep->declBus(c+170,"LEDS_SIZE", false,-1, 31,0);
    tracep->declBus(c+171,"BUTTONS_START", false,-1, 31,0);
    tracep->declBus(c+170,"BUTTONS_SIZE", false,-1, 31,0);
    tracep->declBus(c+172,"SWITCHES_START", false,-1, 31,0);
    tracep->declBus(c+170,"SWITCHES_SIZE", false,-1, 31,0);
    tracep->declBus(c+173,"SEGMENTS_START", false,-1, 31,0);
    tracep->declBus(c+170,"SEGMENTS_SIZE", false,-1, 31,0);
    tracep->declBus(c+174,"UART_START", false,-1, 31,0);
    tracep->declBus(c+170,"UART_SIZE", false,-1, 31,0);
    tracep->declBus(c+175,"TIMER_START", false,-1, 31,0);
    tracep->declBus(c+176,"TIMER_SIZE", false,-1, 31,0);
    tracep->declBus(c+177,"VGA_START", false,-1, 31,0);
    tracep->declBus(c+178,"VGA_SIZE", false,-1, 31,0);
    tracep->declBus(c+179,"TEST_START", false,-1, 31,0);
    tracep->declBus(c+176,"TEST_SIZE", false,-1, 31,0);
    tracep->declBus(c+180,"RESET_ADDRESS", false,-1, 31,0);
    tracep->declBus(c+181,"NOP", false,-1, 31,0);
}
...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_init_sub__TOP__tb_top_cpu__DOT__wb_imem__0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+146,"dat_miso", false,-1, 31,0);
    tracep->declBit(c+136,"cyc", false,-1);
    tracep->declBit(c+137,"stb", false,-1);
    tracep->declBit(c+138,"we", false,-1);
    tracep->declBit(c+147,"ack", false,-1);
    tracep->declBit(c+145,"err", false,-1);
}
...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_init_sub__TOP__tb_top_cpu__DOT__wb_dmem__0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    const int c = vlSymsp->__Vm_baseCode;
    // Body
    tracep->declBus(c+139,"adr", false,-1, 31,0);
    tracep->declBus(c+140,"sel", false,-1, 3,0);
    tracep->declBus(c+141,"dat_mosi", false,-1, 31,0);
    tracep->declBus(c+148,"dat_miso", false,-1, 31,0);
    tracep->declBit(c+142,"cyc", false,-1);
    tracep->declBit(c+143,"stb", false,-1);
    tracep->declBit(c+144,"we", false,-1);
    tracep->declBit(c+149,"ack", false,-1);
    tracep->declBit(c+150,"err", false,-1);
}
...
VL_ATTR_COLD void Vtb_top_cpu___024root__trace_full_sub_0(Vtb_top_cpu___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+106,((0x1fU & vlSelf->tb_top_cpu__DOT__dut__DOT__execute_inst__DOT__op2)),5);
    bufp->fullCData(oldp+107,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__status_forwards_out),4);
    bufp->fullBit(oldp+108,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__wb_state));
    bufp->fullIData(oldp+109,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__pc),32);
    bufp->fullIData(oldp+110,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__request_pc),32);
    bufp->fullBit(oldp+111,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__pending_valid));
    bufp->fullIData(oldp+112,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__pending_instr),32);
    bufp->fullIData(oldp+113,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__pending_pc),32);
    bufp->fullCData(oldp+114,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__pending_status),4);
    bufp->fullBit(oldp+115,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__kill_response));
    bufp->fullBit(oldp+116,((1U == (IData)(vlSelf->tb_top_cpu__DOT__dut__DOT__decode_backwards_out))));
    bufp->fullBit(oldp+117,((2U == (IData)(vlSelf->tb_top_cpu__DOT__dut__DOT__decode_backwards_out))));
    bufp->fullBit(oldp+118,((1U & (~ ((IData)(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__wb_state) 
    ...
    bufp->fullCData(oldp+119,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__status_forwards_out),4);
    bufp->fullBit(oldp+120,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__is_load));
    bufp->fullBit(oldp+121,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__is_store));
    bufp->fullBit(oldp+122,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__wb_state));
    bufp->fullWData(oldp+123,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_instr),65);
    bufp->fullIData(oldp+126,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_source_data),32);
    bufp->fullIData(oldp+127,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_rd_data),32);
    bufp->fullIData(oldp+128,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_pc),32);
    bufp->fullIData(oldp+129,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_next_pc),32);
    bufp->fullBit(oldp+130,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_is_load));
    bufp->fullBit(oldp+131,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__active_is_store));
    bufp->fullBit(oldp+132,(vlSelf->tb_top_cpu__DOT__dut__DOT__writeback_inst__DOT__writes_rd));
    bufp->fullIData(oldp+133,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.adr),32);
    bufp->fullCData(oldp+134,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.sel),4);
    bufp->fullIData(oldp+135,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.dat_mosi),32);
    bufp->fullBit(oldp+136,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.cyc));
    bufp->fullBit(oldp+137,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.stb));
    bufp->fullBit(oldp+138,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.we));
    bufp->fullIData(oldp+139,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.adr),32);
    bufp->fullCData(oldp+140,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.sel),4);
    bufp->fullIData(oldp+141,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.dat_mosi),32);
    bufp->fullBit(oldp+142,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.cyc));
    bufp->fullBit(oldp+143,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.stb));
    bufp->fullBit(oldp+144,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.we));
    bufp->fullBit(oldp+145,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.err));
    bufp->fullIData(oldp+146,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.dat_miso),32);
    bufp->fullBit(oldp+147,(vlSymsp->TOP__tb_top_cpu__DOT__wb_imem.ack));
    bufp->fullIData(oldp+148,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.dat_miso),32);
    bufp->fullBit(oldp+149,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.ack));
    bufp->fullBit(oldp+150,(vlSymsp->TOP__tb_top_cpu__DOT__wb_dmem.err));
    bufp->fullBit(oldp+151,(vlSelf->tb_top_cpu__DOT__clk));
    bufp->fullBit(oldp+152,(vlSelf->tb_top_cpu__DOT__rst));
    bufp->fullBit(oldp+153,(vlSelf->tb_top_cpu__DOT__dut__DOT__fetch_inst__DOT__response_valid));
    bufp->fullIData(oldp+154,(vlSelf->tb_top_cpu__DOT__dut__DOT__memory_inst__DOT__load_value),32);
    bufp->fullIData(oldp+155,(vlSelf->tb_top_cpu__DOT__unnamedblk1__DOT__i),32);
    bufp->fullIData(oldp+156,(vlSelf->tb_top_cpu__DOT__unnamedblk2__DOT__i),32);
    ...
    bufp->fullIData(oldp+163,(0x13U),32);
    __Vtemp_h3441a5c4__0[0U] = 0U;
    __Vtemp_h3441a5c4__0[1U] = 0x90000000U;
    __Vtemp_h3441a5c4__0[2U] = 0U;
    bufp->fullWData(oldp+164,(__Vtemp_h3441a5c4__0),65);
    bufp->fullIData(oldp+167,(0x10000U),32);
    bufp->fullIData(oldp+168,(0x2000U),32);
    bufp->fullIData(oldp+169,(0x80000U),32);
    bufp->fullIData(oldp+170,(1U),32);
    bufp->fullIData(oldp+171,(0x81000U),32);
    bufp->fullIData(oldp+172,(0x82000U),32);
    bufp->fullIData(oldp+173,(0x83000U),32);
    bufp->fullIData(oldp+174,(0x84000U),32);
    bufp->fullIData(oldp+175,(0x85000U),32);
    bufp->fullIData(oldp+176,(5U),32);
    bufp->fullIData(oldp+177,(0x90000U),32);
    bufp->fullIData(oldp+178,(0x9600U),32);
    bufp->fullIData(oldp+179,(0x120000U),32);
    bufp->fullIData(oldp+180,(0x40000U),32);
    bufp->fullIData(oldp+181,(0x13U),32);
}
