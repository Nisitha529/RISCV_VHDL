...
void Vtb_execute_stage___024root___eval_triggers__act(Vtb_execute_stage___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.at(1U) = ((IData)(vlSelf->tb_execute_stage__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigrprev__TOP__tb_execute_stage__DOT__clk)));
    vlSelf->__VactTriggered.at(2U) = ((IData)(vlSelf->tb_execute_stage__DOT__rst) 
                                      != (IData)(vlSelf->__Vtrigrprev__TOP__tb_execute_stage__DOT__rst));
    vlSelf->__VactTriggered.at(3U) = ((~ (IData)(vlSelf->tb_execute_stage__DOT__clk)) 
                                      & (IData)(vlSelf->__Vtrigrprev__TOP__tb_execute_stage__DOT__clk));
